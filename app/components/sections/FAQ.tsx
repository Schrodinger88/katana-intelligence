...
const faqs = [
    ...
    },
    {
        ...
        answer: "You'll typically see a working pilot within weeks, not months. We move fast, test early, and scale only once it's proven. Most clients see their first automations live within 3 days."
    },
    {
    ...
    },
    {
        ...
        answer: "We use a mix of AI tools, n8n, Make, custom APIs, MCPs, OpenClaw, Claude Code, Codex, Gemini, Hermes and platforms like Notion and Cal whatever fits your existing stack. We adapt to your tools, not the other way around."
    },
];
